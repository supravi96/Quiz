			...
			<div class="sidebar">
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-3 bhoechie-tab-menu">
					<div class="list-group">
						<a ng-href="Instructions" class="list-group-item text-center">
							<h4 class="glyphicon glyphicon-plane"></h4><br/>QUIZ
						</a>
						<a ng-href="Questionans" class="list-group-item text-center">
							<h4 class="glyphicon glyphicon-plane"></h4><br/>Question Set
						</a>
						<a ng-href="#" class="list-group-item text-center">
							<h4 class="glyphicon glyphicon-road"></h4><br/>Report
						</a>
						<a ng-href="Teaminfo" class="list-group-item text-center">
